...
const ProjectManagement = () => {
  ...
  return (
    <div className="pt-[140px] flex items-center justify-center text-[#212529]">
      <div className="flex max-lg:flex-col justify-evenly items-center gap-5 px-6">
        ...
        <div className="bg-[#C4DEFD] max-lg:mt-[60px] 2xl:w-[748px] 2xl:h-[547px] xl:w-[650px] xl:h-[448px] lg:w-[527.74px] lg:h-[320px] sm:w-[561px] sm:h-[349px] w-[286px] h-[177px]" />
      </div>
    </div>
  );
};
